...
<html>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
        ...
        <table class="table table-bordered" id="reports_table" style="width : 100%">
          <tr>
            <thead>
              <th>Report Number</th>
              <th>Model Number</th>
...
<script>
  $('document').ready(function(){
      var table = $('#reports_table').DataTable({
              "processing" : true,
              "ajax" : {
                  "url" : "../../controllers/reports/view_all_report_details.php",
                  dataSrc : '',
                  dataType : 'json',
                  "order": [[0, "asc"]]
              },
              "columns" : [ {
                ...
                "data" : "report_id",
                "render": function(data, type, full){
                  return '<a style:"margin-bottom:2px;"><button type="button" class="btn btn-primary" style="margin-right: 10px" onclick=editRecord(' +data+ ')>Edit</button></a>' +
                    '</br><a style="margin-top:2px;margin-bottom:2px;"><button type="button" class="btn btn-secondary" style="margin-right: 10px" onclick=deleteRecord(' +data+ ')>Delete</button></a>' +
                    '</br><a style="margin-top:2px;"><button type="button" class="btn btn-danger" style="margin-right: 10px" onclick=viewRecord(' +data+ ')>View</button></a>';
                }
              }]
      });
